...
{
RobotController::RobotController() : controller_interface::ControllerInterface(), logger_(rclcpp::get_logger("DeliRasp")) {}

controller_interface::CallbackReturn RobotController::on_init()
{
  RCLCPP_INFO(logger_, "RobotController::on_init...");
...
{
  RCLCPP_INFO(logger_, "RobotController::on_configure...");
  auto callback =
  ...
  const
{
  ...
  return conf;  // ["joint_1/position", "joint_1/velocity", "joint_2/position", "joint_2/velocity", ...]
}
